    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex items-center justify-center p-4 transition-colors duration-200">
      <div className="bg-white dark:bg-gray-900 w-full max-w-md rounded-2xl shadow-lg p-8">
        <div className="flex items-center justify-center gap-2 mb-4">
          <img src={logo} alt="Budget Sathi" className="h-28 w-auto" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-full border-2 border-purple-800 dark:border-purple-500 bg-white dark:bg-gray-900 text-black dark:text-gray-100 py-2.5 font-medium hover:bg-purple-800 dark:hover:bg-purple-700 hover:text-white transition-colors mt-4 mb-2 duration-200 disabled:opacity-50"
          >
